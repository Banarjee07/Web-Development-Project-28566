...
{   
?>                       
<li><a href="notice-details.php?nid=<?php echo htmlentities($result->id);?>" target="_blank"><?php echo 
htmlentities($result->noticeTitle);?></li> 
<?php }} ?> 
</ul> 
</marquee> 
</div> 
...
<div class="container"><p class="m-0 text-center text-white"> Student Result Management 
System</p></div> 
</footer> 
<!-- Bootstrap core JS--> 
