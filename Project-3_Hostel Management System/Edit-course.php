...
<div class="col-sm-8"> 
<input type="text"  name="cc" value="<?php echo $row
>course_code;?>"  class="form-control"> </div> 
</div> 
<div class="form-group"> 
<label class="col-sm-2 control-label">Course Name (Short)</label> 
<div class="col-sm-8"> 
<input type="text" class="form-control" name="cns" id="cns" value="<?php echo $row
>course_sn;?>" required="required"> 
</div> 
</div> 
<div class="form-group"> 
label">Course Name(Full)</label> 
class="form-control" name="cnf" value="<?php echo $row->course_fn;?>" > 
</div> 
<?php } ?> 
