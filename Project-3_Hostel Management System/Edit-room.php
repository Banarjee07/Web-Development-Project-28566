...
<div class="col-sm-8"> 
<input type="text"  name="seater" value="<?php echo $row
<div class="panel-body"> 
<form method="post" 
>seater;?>"  class="form-control"> </div> 
</div> 
<div class="form-group"> 
<label class="col-sm-2 control-label">Room no </label> 
<div class="col-sm-8"> 
<input type="text" class="form-control" name="rmno" id="rmno" value="<?php echo $row
>room_no;?>" disabled> 
