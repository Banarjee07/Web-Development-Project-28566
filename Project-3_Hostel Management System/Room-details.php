...
popUpWin 
= 
'toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=no,copyhistory=yes,widt
 h='+510+',height='+430+',left='+left+', top='+top+',screenX='+left+',screenY='+top+''); 
} 
</script> 
</head> 
<body> 
...
Details</div> 
<div class="col-md-12"> 
<h2 class="page-title" style="margin-top:3%">Rooms 
<div class="panel panel-default"> 
<div 
class="panel-heading">All Room 
<div class="panel-body"> 
open(URLStr,'popUpWin', 
border="1"> 
<table id="zctb" class="table table-bordered " cellspacing="0" width="100%" 
<span style="float:left" ><i class="fa fa-print fa-2x" aria
hidden="true" OnClick="CallPrint(this.value)" style="cursor:pointer" title="Print the Report"></i></span> 
<tbody> 
<?php  
$aid=$_SESSION['login']; 
